...
class Optimizer:
    ...
    def solve_once(self, problem: Union[Dict, Problem] = None, mode: str = 'single', n_workers: int = None,
              ...
              seed: int = None, min_value = None) -> Agent:
        """
        Args:
    ...
    def solve_multiple_times(self, problem, mode='single', n_workers=None, termination=None, starting_solutions=None, seed=None, trials=100, min_value = None):
